<h1>Active Directory Home Lab With Bulk User Creation (Josh Madakor Youtube Active Directory Home Labs With Bulk User Creation walkthrough followed with few changes)</h1>
